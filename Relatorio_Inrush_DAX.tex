...
\begin{itemize}[label=\textendash]
	\item	Potencia reativa  = $401$ MVAr
	\item	Tensão trifásica  = $230$ kV
	\item	Tensão monofásica  = $133$ kV
	\item	Corrente de curto-circuito  = $63$ kA
\end{itemize}
...
\midrule
0 & $100$ MVAr & $33$ MVAr & $230$ kV & $133$ kV & $251$ A & $529.0$ $\Omega$ & $5.01$ µF & $265$ µH & $21.7$ & $928$ Hz \\
1 & $111$ MVAr & $37$ MVAr & $230$ kV & $133$ kV & $279$ A & $476.6$ $\Omega$ & $5.57$ µF & $265$ µH & $46.6$ & $4$ kHz \\
2 & $95$ MVAr & $32$ MVAr & $230$ kV & $133$ kV & $238$ A & $556.8$ $\Omega$ & $4.76$ µF & $1$ µH & $86.2$ & $5$ kHz \\
3 & $95$ MVAr & $32$ MVAr & $230$ kV & $133$ kV & $238$ A & $556.8$ $\Omega$ & $4.76$ µF & $1$ µH & $91.5$ & $5$ kHz \\
\bottomrule
\end{tabular}
...
\begin{itemize}[label=\textendash]
	...
	\item	Frequência de Oscilação: $5.0$ kHz;
	\item	Corrente inrush / Corrente nominal: $91.5$
\end{itemize}
