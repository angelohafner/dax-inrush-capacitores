...
\begin{itemize}[label=\textendash]
	\item	Potencia reativa  = $401$ M
	\item	Tensão trifásica  = $230$ k
	\item	Tensão monofásica  = $133$ k
	\item	Corrente de curto-circuito  = $63$ k
\end{itemize}

\begin{center}
	\begin{tabular}{lllllllll}
\toprule
 & $Q_{3\phi}$ & $Q_{1\phi}$ & $V_{3\phi}$ & $V_{1\phi}$ & $I_{1\phi}$ & $X_{1\phi}$ & $C_{1\phi}$ & $L_{1\phi}$ \\
\midrule
0 & $100$ MVAr & $33$ MVAr & $230$ kV & $133$ kV & $251$ A & $529.0$ $\Omega$ & $5.01$ µF & $265$ µH \\
1 & $111$ MVAr & $37$ MVAr & $230$ kV & $133$ kV & $279$ A & $476.6$ $\Omega$ & $5.57$ µF & $265$ µH \\
2 & $95$ MVAr & $32$ MVAr & $230$ kV & $133$ kV & $238$ A & $556.8$ $\Omega$ & $4.76$ µF & $1$ µH \\
3 & $95$ MVAr & $32$ MVAr & $230$ kV & $133$ kV & $238$ A & $556.8$ $\Omega$ & $4.76$ µF & $1$ µH \\
\bottomrule
\end{tabular}
...
São os valores obtidos com o reator escolhido ($L_{reator} = $265.0$ \, \mu \rm{H} $):
\begin{itemize}[label=\textendash]
	\item	Corrente de pico: $31$ kA;
	\item	Frequência de Oscilação: $5$ kHz;
	\item	Corrente inrush / Corrente nominal: $87.0$
\end{itemize}
