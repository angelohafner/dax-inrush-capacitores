...
\begin{itemize}[label=\textendash]
	\item	Potencia reativa $ = {{potencia_reativa_do_banco}} \, \rm{kVAr} $
	\item	Tensão trifásica $ = {{tensao_trifasica}} \rm{kV} $
	\item	Tensão monofásica $ = {{tensao_monofasica}} \, \rm{kV} $
	\item	Corrente de curto-circuito $ = {{corrente_de_curto}} \, \rm{kA} $
\end{itemize}

\begin{tabular}{lrrrrrrr}
\toprule
 & kVAr trifsicos & kVAr monofsicos & kV trifsico & kV de fase & A de fase & ohms de fase & uF de fase \\
\midrule
0 & 100000.00 & 33333.33 & 230.00 & 132.79 & 251.02 & 529.00 & 5.01 \\
1 & 111000.00 & 37000.00 & 230.00 & 132.79 & 278.63 & 476.58 & 5.57 \\
\bottomrule
\end{tabular}
...
\begin{itemize}[label=\textendash]
	\item	Corrente de pico: ${{corrente_pico}} \, \rm{A}$;
	\item	Frequência de Oscilação: ${{frequencia_oscilacao}} \, \rm{Hz}$
